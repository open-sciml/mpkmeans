...
def plot(DELTAS):
    ...
    ax1.plot(DELTAS, norm_ari_arr_fp16.iloc[0, 1:], label='fp16 (normalized)', marker='^', linestyle='--', c='darkred', linewidth=2, markersize=13, markeredgecolor='cyan')
    ...
    ax1.plot(DELTAS, norm_ari_arr_q52.iloc[0, 1:], label='q52 (normalized)', marker='*', linestyle=':', c='darkgreen', linewidth=2, markersize=13, markeredgecolor='cyan')
    ...
    ax2.plot(DELTAS, norm_ari_arr_fp16.iloc[1, 1:], label='fp16 (normalized)', marker='^', linestyle='--', c='darkred', linewidth=2, markersize=13, markeredgecolor='cyan')
    ...
    ax2.plot(DELTAS, norm_ari_arr_q52.iloc[1, 1:], label='q52 (normalized)', marker='*', linestyle=':', c='darkgreen', linewidth=2, markersize=13, markeredgecolor='cyan')
    ...
    ax1.plot(DELTAS, norm_ami_arr_fp16.iloc[0, 1:], label='fp16 (normalized)', marker='^', linestyle='--', c='darkred', linewidth=2, markersize=13, markeredgecolor='cyan')
    ...
    ax1.plot(DELTAS, norm_ami_arr_q52.iloc[0, 1:], label='q52 (normalized)', marker='*', linestyle=':', c='darkgreen', linewidth=2, markersize=13, markeredgecolor='cyan')
    ax1.set_xlabel("$\delta$", fontsize=20)
    ax1.set_ylabel("AMI")
    ax1.title.set_text("Cluster $\sigma$=1")
    ...
    ax2.plot(DELTAS, norm_ami_arr_fp16.iloc[1, 1:], label='fp16 (normalized)', marker='^', linestyle='--', c='tomato', linewidth=2, markersize=13, markeredgecolor='cyan')
    ...
    ax2.plot(DELTAS, norm_ami_arr_q52.iloc[1, 1:], label='q52 (normalized)', marker='*', linestyle=':', linewidth=2, markersize=13, markeredgecolor='cyan')
    ax2.set_xlabel("$\delta$", fontsize=20)
    ax2.set_ylabel("AMI")
    ax2.title.set_text("Cluster $\sigma$=2")
    ...
    ax1.plot(DELTAS, norm_trigger_arr_fp16.iloc[0, 1:], label='fp16 (normalized)', marker='^', linestyle='--', c='darkred', linewidth=2, markersize=13, markeredgecolor='cyan')
    ...
    ax1.plot(DELTAS, norm_trigger_arr_q52.iloc[0, 1:], label='q52 (normalized)', marker='*', linestyle=':', c='darkgreen', linewidth=2, markersize=13, markeredgecolor='cyan')
    ax1.set_xlabel("$\delta$", fontsize=20)
    ...
    ax2.plot(DELTAS, norm_trigger_arr_fp16.iloc[1, 1:], label='fp16 (normalized)', marker='^', linestyle='--', c='darkred', linewidth=2, markersize=13, markeredgecolor='cyan')
    ...
    ax2.plot(DELTAS, norm_trigger_arr_q52.iloc[1, 1:], label='q52 (normalized)', marker='*', linestyle=':', c='darkgreen', linewidth=2, markersize=13, markeredgecolor='cyan')
    ax2.set_xlabel("$\delta$", fontsize=20)
