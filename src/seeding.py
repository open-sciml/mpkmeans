...
def all_low_d2_seeding1(
    ...
    # pairw_distm = distance.squareform(distance.pdist(X, metric=metric))
    pairw_distm = pairwise_low_prec_q1(X, X, low_prec)
...
def all_low_d2_seeding2(
    ...
    # pairw_distm = distance.squareform(distance.pdist(X, metric=metric))
    pairw_distm = pairwise_low_prec_q2(X, X, low_prec)
...
def mp_low_d2_seeding2(
    ...
    # pairw_distm = distance.squareform(distance.pdist(X, metric=metric))
    pairw_distm, _ = pairwise_mix_prec(X, X, low_prec)
